...
STRINGS = {
    # Title
    'title': {'zh': 'DDR XMP Editor Pro V1.7 — 周强  cnns@sina.com',
              'en': 'DDR XMP Editor Pro V1.7'},
    ...
    # Help content
    'help_title': {'zh': 'DDR XMP Editor Pro V1.7 — 使用说明', 'en': 'DDR XMP Editor Pro V1.7 — Usage Guide'},
    'help_text': {
        'zh': (
            "DDR XMP Editor Pro V1.7\n"
