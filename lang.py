...
STRINGS = {
    # Title
    'title': {'zh': 'DDR XMP Editor Pro V1.8 — 周强  cnns@sina.com',
              'en': 'DDR XMP Editor Pro V1.8'},
    ...
    # Help content
    'help_title': {'zh': 'DDR XMP Editor Pro V1.8 — 使用说明', 'en': 'DDR XMP Editor Pro V1.8 — Usage Guide'},
    'help_text': {
        'zh': (
            "DDR XMP Editor Pro V1.8\n"
