...
STRINGS = {
    # Title
    'title': {'zh': 'DDR XMP Editor Pro V1.9 — 周强  cnns@sina.com',
              'en': 'DDR XMP Editor Pro V1.9'},
    ...
    # Help content
    'help_title': {'zh': 'DDR XMP Editor Pro V1.9 — 使用说明', 'en': 'DDR XMP Editor Pro V1.9 — Usage Guide'},
    'help_text': {
        'zh': (
            "DDR XMP Editor Pro V1.9\n"
