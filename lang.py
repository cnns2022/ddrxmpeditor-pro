...
STRINGS = {
    # Title
    'title': {'zh': 'DDR XMP Editor Pro V1.4 — 周强  cnns@sina.com',
              'en': 'DDR XMP Editor Pro V1.4'},
    ...
    # Help content
    'help_title': {'zh': 'DDR XMP Editor Pro V1.4 — 使用说明', 'en': 'DDR XMP Editor Pro V1.4 — Usage Guide'},
    'help_text': {
        'zh': (
            "DDR XMP Editor Pro V1.4\n"
